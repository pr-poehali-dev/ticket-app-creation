...
const questions: Question[] = [
  {
    id: 1,
    question: 'Какое максимальное наказание за управление ТС в состоянии опьянения?',
    options: [
      'Штраф 30 000 руб.',
      'Лишение прав на 1.5-2 года и штраф 30 000 руб.',
      'Лишение прав на 6 месяцев',
  ...
  },
  {
    ...
    options: [
      'Разрешается',
      'Разрешается только на обочине',
      'Запрещается',
      'Разрешается в крайней правой полосе'
    ],
    correctAnswer: 2
  },
  {
  ...
  {
    id: 5,
    question: 'Обязан ли водитель предоставить ТС медицинским работникам для доставки пациента?',
    options: [
      'Обязан в любом случае',
      'Обязан только при ЧС',
      'Не обязан',
      'Обязан только в сельской местности'
    ],
    correctAnswer: 1
  }
];
